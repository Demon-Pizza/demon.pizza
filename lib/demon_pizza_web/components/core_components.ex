defmodule DemonPizzaWeb.CoreComponents do
  @moduledoc """
  ...
  def translate_error({msg, opts}) do
    ...
    if count = opts[:count] do
      Gettext.dngettext(DemonPizzaWeb.Gettext, "errors", msg, msg, count, opts)
    else
      Gettext.dgettext(DemonPizzaWeb.Gettext, "errors", msg, opts)
    end
  end
