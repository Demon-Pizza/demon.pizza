defmodule DemonPizzaWeb.Router do
  use DemonPizzaWeb, :router

  import DemonPizzaWeb.UserAuth

  pipeline :browser do
    plug :accepts, ["html"]
    plug :fetch_session
    plug :fetch_live_flash
    plug :put_root_layout, html: {DemonPizzaWeb.Layouts, :root}
  ...
  if Application.compile_env(:demon_pizza, :dev_routes) do
    ...
    scope "/dev" do
      ...
      live_dashboard "/dashboard", metrics: DemonPizzaWeb.Telemetry
  ...
  scope "/", DemonPizzaWeb do
    ...
    live_session :redirect_if_user_is_authenticated,
      on_mount: [{DemonPizzaWeb.UserAuth, :redirect_if_user_is_authenticated}] do
  ...
  scope "/", DemonPizzaWeb do
    ...
    live_session :require_authenticated_user,
      on_mount: [{DemonPizzaWeb.UserAuth, :ensure_authenticated}] do
